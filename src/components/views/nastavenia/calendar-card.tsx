    ...
    <section className="flex flex-col gap-3 rounded border border-border bg-surface p-4">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-[13px] leading-relaxed text-fg-muted">
          Keď ho prepojíš, na obrazovke „Dnes“ uvidíš svoje porady a ich čas sa
          odráta z rozpočtu dňa. Prístup je <strong className="font-medium">len
          na čítanie</strong> — appka ti do kalendára nikdy nič nezapíše ani
          nezmaže.
        </p>
      </div>
